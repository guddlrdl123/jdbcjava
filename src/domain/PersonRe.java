...
// record 객체 선언 - class 대신에 record
// 클래스 선언시에 없던 "()" 사용한다.
// 1. 간결한 객체 정의
// 2. 메서드 자동 생성
// 3. 생성자 자동 생성(Builder 객체 사용)
// 4. 불변성(***) - 객체 안에 있는 멤버변수들은 final의 속성을 가지고 있다.
// getter 기본 설정.
public record PersonRe(
        // 멤버 변수 선언 위치
        int id, String userId, String userPw, String userName,
        String userEmail, String phone1, String phone2,
