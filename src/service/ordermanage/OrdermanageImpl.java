...
public class OrdermanageImpl implements Ordermanage {
    ...
    public boolean deleteOrder(OrderDTO order, UserDTO userDTO) {
        ...
        if (userInfo.isPresent()) {
            ...
            // userInfo.get().getUserPw()는 DB에 있는 사용자의 패스워드를 가져옴
    ...
    public List<OrderDTO> findAll() {
        ...
        List<OrdersVO> orderVOList = orderRepository.ordersList();
    ...
    public List<OrderDTO> findDate(String dateString) {
        ...
        OrdersVO vo = orderRepository.ordersSearchDate(dateString).get(0);
        SimpleDateFormat sf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    ...
    public List<OrderDTO> findUserId(String userId) {
        // 특정 사용자 주문 내역
        List<OrderDTO> dtoList = new ArrayList<>();
        OrdersVO vo = orderRepository.ordersSearch(userId).get(0);
        SimpleDateFormat sf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        dtoList.add(OrderDTO.builder()
                .id(vo.getId())
                .orderList(vo.getOrderList())
